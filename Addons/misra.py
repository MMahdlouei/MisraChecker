...
def main(FilePath, TextPath):
    parser = get_args_parser()
    parser.add_argument('--dumpfile', nargs='+', default=["majid"], help='Description of dumpfile argument')
    # parser.add_argument("--rule-texts", type=str, help=RULE_TEXTS_HELP)
    args = parser.parse_args()
    args.dumpfile = [FilePath]
    # args = parser.parse_args()
    args.rule_texts = TextPath
    print(args.rule_texts)
